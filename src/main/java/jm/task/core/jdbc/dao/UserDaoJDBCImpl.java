...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void createUsersTable() {
        try (Statement statement = connection.createStatement()) {
           statement.executeUpdate("CREATE TABLE IF NOT EXISTS users (id bigint NOT NULL PRIMARY KEY AUTO_INCREMENT, name varchar(45), lastName varchar(45), age tinyint)");
